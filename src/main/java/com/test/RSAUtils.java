...
//        System.out.println("解密后文字: \r\n" + decodedData);
        ...
        String strx = "你好，周末";
        System.out.println("\r明文：\r\n" + strx);
        System.out.println("\r明文大小：\r\n" + strx.getBytes().length);
        String encodedDatax = RSAUtils.privateEncrypt(strx, RSAUtils.getPrivateKey(privateKey));  //传入明文和公钥加密,得到密文
        System.out.println("密文：\r\n" + encodedDatax);
        String decodedDatax = RSAUtils.publicDecrypt(encodedDatax,RSAUtils.getPublicKey(publicKey)); //传入密文和私钥,得到明文
        System.out.println("解密后文字: \r\n" + decodedDatax);
